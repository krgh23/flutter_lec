...
// 주요 속성
// 1. size : 화면의 크기
// 2. orientation : 화면의 방향(portrait : 화면 세움(디폴트), landscape: 화면눕힘)
// 3. padding : 화면의 내부 여백
...
class MediaQueryWidget extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    ...
    // MediaQuert.of(BuildContext context)
    // 현재 Buildcontext에 대한 MediaQueryData를 가져와서 화면의 다양한 속성에 접글할 수 있습니다.
    final mediaQuery = MediaQuery.of(context); //final 뒤에 타입은 생략가능
  ...
  */
  ...
  Widget build(BuildContext context) {
    ...
    return Container( //Container 단일자식일떄 사용
      height: safeHeight,
